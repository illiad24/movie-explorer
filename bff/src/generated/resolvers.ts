...
export type MediaItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['MediaItem'] = ResolversParentTypes['MediaItem']> = ResolversObject<{
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  search?: Resolver<Array<ResolversTypes['MediaItem']>, ParentType, ContextType, RequireFields<QuerySearchArgs, 'query'>>;
}>;
